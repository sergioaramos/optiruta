...
export const personal = {
  ...
  motivationalMessages: [
    ...
    '🏅 Lo que haces no es solo un trabajo, es vocación pura',
    '☀️ Buenos días, fisio favorita del universo',
    '🧠 Tus manos y tu conocimiento hacen milagros a diario',
    '🌺 Hoy también vas a dejar una huella positiva en cada hogar',
    '💌 Cada paciente que ves tiene suerte de tenerte a ti',
    '🎯 Enfocada, preparada y absolutamente imparable',
    '🌈 Nada te detiene cuando te propones algo. Hoy tampoco',
    '🩺 La mejor fisioterapeuta de Manizales ya está en línea',
    '⭐ El esfuerzo que pones en cada visita se nota, y mucho',
    '🤝 Gracias por cuidar a los demás con tanta dedicación',
    '💫 Hoy repartes bienestar, mañana recoges gratitud',
    '🫂 Tus pacientes no solo mejoran físicamente, también anímicamente',
    '🌻 El mundo es mejor lugar porque tú eliges ayudar',
  ],
